    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.left_trigger>0){
                motorBackLeft.setPower(backLeftPower/(3* gamepad1.left_trigger));
                motorBackRight.setPower(backRightPower/(3* gamepad1.left_trigger));
                motorFrontRight.setPower(frontRightPower/(3* gamepad1.left_trigger));
                motorFrontLeft.setPower(frontLeftPower/(3* gamepad1.left_trigger));
            }
